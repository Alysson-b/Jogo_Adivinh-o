...
import type { LetterUsedProps } from "./components/Letters"
...
export default function App() {
  ...
  // Foca o input sempre que a letra for limpa ou o desafio mudar
  useEffect(() => {
    ...
    <div className={styles.container}>
      <main>
        ...
        <div className={styles.word}>
          {challenge.word.split("").map((letterChar, index) => {
            const letterUsed = lettersUsed.find(
              (used) => used.value.toUpperCase() === letterChar.toUpperCase()
            )
